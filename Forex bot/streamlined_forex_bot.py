...
class Config:
    # API Keys
    TELEGRAM_BOT_TOKEN = os.getenv('TELEGRAM_BOT_TOKEN', '8213684963:AAHti8XLUY-c2HL7jGdDkjTPNTBLnfDMCdw')
    TWELVE_DATA_API_KEY = os.getenv('TWELVE_DATA_KEY', '9d777272cbfc4fba9f9ee3c97f716963')
    DEEPSEEK_API_KEY = os.getenv('DEEPSEEK_API_KEY', 'sk-2a22d0612972414f9e97695bfe9e494f')
